...
def main():
    """Runtime code. Always indent a funtion"""
    ...
    print(crayons.green('Evan', bold=True))
    print(crayons.cyan('Alrutz', bold=True))

# we must call on our main function or our code will not run
main()
